export default function SeekPre({ className, onClick }: { className?: string, onClick?: () => void }) {
  return (
    <svg
      width="64"
      height="64"
    ...
    >
      <g clip-path="url(#clip0_3_10177)">
        ...
        <path
          ...
          fill="black"
          mask="url(#path-16-outside-1_3_10177)"
        />
      </g>
      <defs>
        <clipPath id="clip0_3_10177">
          <rect width="64" height="64" fill="white" />
        </clipPath>
        <clipPath id="clip1_3_10177">
          <rect width="64" height="64" fill="white" />
        </clipPath>
      </defs>
    </svg>
