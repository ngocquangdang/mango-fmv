export default function GiftCard({ text = "xin chào" }: { text: string }) {
  return (
    <div className='min-h-[96px]'>
      <svg width="379" height="96" viewBox="0 0 379 96" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" className="w-[379px] h-[96px]">
